...
<div style="margin: 0 auto; width: 1900px; height:2110px; position: relative; margin-top: 100px;">
    ...
    <form action="insert.ab" id="about_insert" method="post" enctype="multipart/form-data">  
	    ...
	    <div style=" width: 1540px; height:2110px; margin-left: 355px; ">
			...
			<input type="text" name="title" style="position: absolute; top: 215px; left: 600px; font-size: 25px; padding: 20px; border: none;">
			<textarea name="content" rows="32" cols="115" style="position: absolute; top: 295px; left: 600px; border: none; padding: 20px; font-size: 20px;"></textarea>
			<label>
	        ...
	        <div style="position: absolute; top: 1130px; left: 830px;">
				...
				<span id='preview' style="width:100px;"></span>
				<span id='delete-file' style='color:red; margin-left:20px; display: none;'><i class='fas fa-times'></i></span>
	        </div>
		</div>
	</form>
	<a onclick="if( necessary() ) { $('#about_insert').submit()}"><img src="imgs/btnsubmit.png" style="position: absolute; top: 1250px; left: 840px; width: 250px; cursor: pointer;"></a>
