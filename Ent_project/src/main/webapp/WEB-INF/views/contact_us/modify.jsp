...
<div style="position: relative;">
	...
	<h3 style="font-weight: bold; font-stretch: normal; font-style: normal; line-height: normal;margin-left:20.5%; letter-spacing: -2.5px; text-align: left; font-size: 23px;">1:1 문의 수정하기</h3>
</div>
<div style="background-color: #e5e5e5; height: 12px; margin-top: 2.5%; margin-bottom: 2.5%"></div>
	...
	<img style="width: 1%" src="imgs/rectangle-3.png">
		<form action="contact_update" method="post" enctype="multipart/form-data">
	        ...
	        <input type="text" value="${vo.web_name }" name="web_name" class="need" title="이름" style="padding-left: 10px;position: absolute; top: 12.5%; left: 19%; border: 0px; width:16%; height: 3.802%; font-size: 21px; border-radius: 10px;" />
	        <input type="text" value="${vo.web_title }" name="web_title" class="need" title="제목" style="padding-left: 10px;position: absolute; top: 20.5%; left: 19%; border: 0px; width:74%; height: 3.802%; font-size: 21px; border-radius: 10px;" />
	        
	        <textarea name="web_content" class="need" title="내용" style="padding-left: 10px;position: absolute; top: 28.5%; left: 19%; border: 0px; width:74%; height: 31.802%; font-size: 21px; border-radius: 10px;">${vo.web_content }</textarea>
	        ...
	        <input type="text" value="${vo.web_pw }" name="web_pw" title="비밀번호" class="need" style="padding-left: 10px;position: absolute; top: 75.5%; left: 19%; border: 0px; width:16%; height: 3.802%; font-size: 21px; border-radius: 10px;" />
...
if(${!empty vo.filename} ){
	...
	if( isImage('${vo.filename}') ){
		var img = "<img class='file-img' src='${vo.filepath}' style='width:40px;' />";
		$('#preview').html(img);
	}
}
